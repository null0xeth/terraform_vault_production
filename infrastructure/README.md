...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_aws_bootstrap"></a> [aws\_bootstrap](#module\_aws\_bootstrap) | github.com/null0xeth/terraform_aws_bootstrap | n/a |
| <a name="module_cloud-init"></a> [cloud-init](#module\_cloud-init) | github.com/null0xeth/terraform_pve_cloud_init | n/a |
| <a name="module_deployment"></a> [deployment](#module\_deployment) | github.com/null0xeth/terraform_pve_vm | n/a |
| <a name="module_letsencrypt_ssl"></a> [letsencrypt\_ssl](#module\_letsencrypt\_ssl) | github.com/null0xeth/terraform_letsencrypt_certificate | n/a |
| <a name="module_render_ansible_templates"></a> [render\_ansible\_templates](#module\_render\_ansible\_templates) | github.com/null0xeth/terraform_template_renderer | n/a |
| <a name="module_render_provisioning_templates"></a> [render\_provisioning\_templates](#module\_render\_provisioning\_templates) | github.com/null0xeth/terraform_template_renderer | n/a |
...
|------|-------------|------|---------|:--------:|
| <a name="input_acme"></a> [acme](#input\_acme) | Variable holding the ACME configuration, passed to the letsencrypt module. | <pre>object({<br>    email       = optional(string)<br>    cf_api_key  = optional(string)<br>    sans        = optional(list(string))<br>    common_name = optional(string)<br>    provider    = optional(string)<br>  })</pre> | `{}` | no |
| <a name="input_ansible_templates"></a> [ansible\_templates](#input\_ansible\_templates) | Map of Templates that we will be rendering in the template\_renderer module | `map(any)` | `{}` | no |
